...
tl.from("#flag-video", 0.5, { opacity: 0 })
	...
	.from('#header-1', 2, {}) // delay
	.to("#header-2", 0.65, { opacity: 0, y: 3, ease: Back.easeOut.config(2) }, "header-2-out")


	.from("#header-3", 0.65, { opacity: 0, y: 3, ease: Back.easeOut.config(2) }, "header-3-in")
	.from('#cta-wrapper', 0.5, { opacity: 0, }, "header-3-in+=0.1")
	.from('#gift-wrapper', 0.5, { y: 50, rotation: 15, ease: Back.easeOut.config(0.65), transformOrigin: "50% 50%" }, "header-3-in");
