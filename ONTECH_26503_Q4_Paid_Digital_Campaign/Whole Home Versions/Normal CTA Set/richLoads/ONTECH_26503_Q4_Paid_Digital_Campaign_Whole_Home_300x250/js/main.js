...
tl.from("#container", .5, { opacity: 0 })
    ...
    .from("#google-screen", .65, { x: 170, ease: Back.easeOut.config(.75) }, "beacon+=0.5")
    .from("#header", .5, { opacity: 0 }, "beacon+=0.75")
    .from("#header", 1.5, {}) // Delay
    .to("#google-screen", .65, { x: 170, ease: Back.easeIn.config(.75) }, "google-out")
    ...
    .from(".image-container", .5, { x: 135, ease: Power2.easeOut }, "subhead+=0.5")
