...
tl.from("#container", .5, { opacity: 0 })
	.from("#beacon", .5, { scale: 17.0, left: 900, top: 270, ease: Power1.easeOut }, "beacon")
	.from("#logo", .5, { opacity: 0, ease: PowerEase }, "beacon+=0.35")
	.from("#google-screen", .5, { y: 90, ease: Back.easeOut.config(.75) }, "beacon+=0.5")
	.from("#header", .5, { opacity: 0 }, "beacon+=0.75")
	.from("#header", 1.5, {}) // Delay
	.to("#google-screen", .5, { y: -90, ease: Back.easeIn.config(.75) }, "google-out")
	.to("#header", .5, { opacity: 0 }, "google-out")
	.to("#beacon", .65, { width: 27, height: 27, y: -20, ease: Back.easeInOut.config(1.5) }, "google-out+=0.25")
	.to("#logo", .65 , { width: 80, height: 25, y: -20, ease: Back.easeInOut.config(1.5) }, "google-out+=0.25")
