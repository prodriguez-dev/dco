...
container.addEventListener("mouseenter", function () {
    restrictions.innerHTML = "Aplican restricciones. <br/>Google es una marca registrada <br/>de Google LLC.";
});
