...
main
  ...
  .to("#bg", 0.7, { x: -312, ease: "power4.inOut" }, "header-1-out")

  .from("#header-1", 1.5, {}) // Delay

  .to("#bg", 0.7, { x: 0, ease: "power4.inOut" }, "header-2-in")
  .to("#logo", 0.7, { y: -16, ease: "power4.inOut" }, "header-2-in-=0.1")
  .from("#header-2",0.4,{ y: 4, opacity: 0 },"header-2-in+=0.3")
  .from("#cta-button, #cta-button-inset",0.5,{ opacity: 0, y: 4, ease: "back.out(4)" },"header-2-in+=0.4")
  .from("#restrictions",0.5,{ opacity: 0, y: 4, ease: "back.out(4)" },"header-2-in+=0.5");
