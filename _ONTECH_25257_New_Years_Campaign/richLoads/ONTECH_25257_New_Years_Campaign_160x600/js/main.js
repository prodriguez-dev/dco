...
class ConfettiParticle {
	...
	reset() {
	  this.lightness = Math.floor(Math.random() * 90) + 50
		// this is where you specify the randomly generated colors
 ...
 //////////////////////  Setup   //////////////////////
  (function() {
	...
	setTimeout(() => {   
		 createParticles();
		 animationFunc();
		// there is a 850 ms delay on the animation begining
	 }, 850);
 ...
 //======= PT 2 =======//
 tl.to("#thermostat", .5, {
	 css: { top: 357, left: 80, width: 80 },
	 ease: Power1.easeOut,
 });
 
 tl.to("#lightbulb", .5, {
	 css: { top: 433, left: 9, width: 63, height: 152 },
	 ease: Power1.easeOut,
	 delay: -.5,
 });
 
 tl.to("#google-mini", .5, {
	 css: { top: 544, left: 53, width: 125 },
	 ease: Power1.easeOut,
	 delay: -.5,
 });
