...
// Small confetti Gold
var confetti_small_gold = 2;

for (i = 0; i < confetti_small_gold; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'confetti-small-gold' }, x: A(-130, w), y: A(-600, -320) });
...
function cluster1(confetti1) {
	...
	TweenMax.to(confetti1, A(14, 10), { rotation: A(0, 260), repeat: -1, yoyo: true, ease: Sine.easeInOut, delay: -1 });
};

// Small confetti Red
var confetti_small_red = 1;

for (i = 0; i < confetti_small_red; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'confetti-small-red' }, x: B(-130, w), y: B(-650, -320) });
	container.appendChild(Div);
	cluster2(Div);
}
function cluster2(confetti2) {
	TweenMax.to(confetti2, B(13, 70), { y: h + 100, x: B(0, w), ease: Linear.easeNone, repeat: -1, delay: -4 });
	TweenMax.to(confetti2, B(20, 45), { x: '+=15', repeat: -1, yoyo: true, ease: Sine.easeInOut });
...
for (i = 0; i < confetti_medium; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'confetti-medium' }, x: C(-130, w), y: C(-650, -320) });
	container.appendChild(Div);
	cluster3(Div);
}
...
for (i = 0; i < confetti_large; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'confetti-large' }, x: D(-110, w), y: D(-740, -320) });
	container.appendChild(Div);
	cluster4(Div);
}
function cluster4(confetti4) {
	TweenMax.to(confetti4, D(22, 60), { y: h + 100, x: D(0, w), ease: Linear.easeNone, repeat: -1, delay: 1 });
	TweenMax.to(confetti4, D(27, 35), { x: '+=30', repeat: -1, yoyo: true, ease: Sine.easeInOut });
	TweenMax.to(confetti4, D(26, 10), { rotation: D(0, 175), repeat: -1, yoyo: true, ease: Sine.easeInOut, delay: -5 });
};
...
for (i = 0; i < confetti_large_gold; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'confetti-large-gold' }, x: D(-110, w), y: D(-770, -320) });
	container.appendChild(Div);
	cluster5(Div);
}
function cluster5(confetti5) {
	TweenMax.to(confetti5, D(19, 60), { y: h + 100, x: D(0, w), ease: Linear.easeNone, repeat: -1, delay: 1 });
	TweenMax.to(confetti5, D(25, 35), { x: '+=30', repeat: -1, yoyo: true, ease: Sine.easeInOut });
	TweenMax.to(confetti5, D(14, 10), { rotation: D(0, 260), repeat: -1, yoyo: true, ease: Sine.easeInOut, delay: -5 });
};

// Functions creating  the clusterconfettis
...
tl.to("#gift-2-top, #gift-2-bow", .75, {
	css: { x: 162, y: -360, rotation: 35 },
	ease: Power1.easeOut,
});
