...
main
  ...
  .from("#tv", 1, { y: -20, ease: "power4.inOut"  }, "header-1")
  ...
  .to("#tv", 0.7, { y: -60, ease: "power2.inOut"  }, "header-1-out")

  .from("#header-2", 0.4, { opacity: 0, y: 4 }, "header-2")
  .staggerFrom(".icon", 0.6, { x: -160, ease: "back.out(1)" }, -0.1, "header-2")
  .from("#header-1", 1.5, {}) // Delay
  .to("#header-2", 0.5, { y: 4, opacity: 0 }, "header-2-out")
  .staggerTo(".icon", 1, { y: -92, ease: "back.inOut(1)" }, 0.1, "header-2-out")
