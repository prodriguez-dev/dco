...
for (i = 0; i < flake1total; i++) {
	...
	TweenLite.set(Div, { attr: { class: 'small-flakes' }, x: A(-130, w), y: A(-600, -320) });
...
for (i = 0; i < flake2total; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'medium-flakes-1' }, x: B(-130, w), y: B(-650, -320) });
	container.appendChild(Div);
	snow2(Div);
}
...
for (i = 0; i < flake3total; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'medium-flakes-2' }, x: C(-130, w), y: C(-650, -320) });
	container.appendChild(Div);
	snow3(Div);
}
...
for (i = 0; i < flake4total; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'medium-flakes-3' }, x: D(-130, w), y: D(-650, -320) });
	container.appendChild(Div);
	snow4(Div);
}
...
for (i = 0; i < flake5total; i++) {
	var Div = document.createElement('div');
	TweenLite.set(Div, { attr: { class: 'large-flakes' }, x: E(-110, w), y: E(-740, -320) });
	container.appendChild(Div);
	snow5(Div);
}
